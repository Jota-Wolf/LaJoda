...
from .views import CasasPageView,CasaLimachePageView,ContactoPageView,DepartamentoPageView,DeptoLimachePageView,GaleriaPageView,IndexPageView,QuienesSomosPageView,TerrenoLimachePageView,TerrenosPageView

urlpatterns = [
    path('', IndexPageView.as_view(), name='home'),
    path("casa-limache/", CasaLimachePageView.as_view(), name="casa_limache"),
    path("casas/", CasasPageView.as_view(), name="casas"),
